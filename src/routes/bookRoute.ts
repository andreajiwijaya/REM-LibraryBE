...
router.put('/:id',
  ...
  body('categoryIds').optional().isArray().withMessage('categoryIds harus berupa array of integers'),
  body('categoryIds.*').isInt().withMessage('Setiap categoryId harus berupa integer'),
