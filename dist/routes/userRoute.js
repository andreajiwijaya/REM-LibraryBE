...
router.post('/', (0, roleMiddleware_1.roleMiddleware)(['admin']), userController.createUser);
router.put('/:id', (0, roleMiddleware_1.roleMiddleware)(['admin']), userController.updateUser);
router.delete('/:id', (0, roleMiddleware_1.roleMiddleware)(['admin']), userController.deleteUser);
